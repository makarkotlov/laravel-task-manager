        ...
        $(document).ready(function () {
            if (window.Laravel.user == e.user) { //if it's the right user we need
                ...
                if (window.location.href == "http://task.loc/tasks") { //if on the right page
                    ...
                    if (e.filePath) {
                        taskDiv.innerHTML = `<a href="http://task.loc/tasks/` + e.task.id + `">
                                                <img src="` + e.filePath + `" class="img-responsive img-rounded">
                    ...
                    if (mustBeRow.classList.contains('row')) { //if any row exists
                        ...
                        $(taskDiv).fadeIn('slow');
                    } else { //else create that row and push the task there
